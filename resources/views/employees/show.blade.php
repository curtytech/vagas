...
@section('title', 'Perfil do Candidato — ' . ($employee->name ?? ''))

@section('content')
@php use Illuminate\Support\Facades\Storage; @endphp

<main>
    <!-- Barra superior opcional com voltar -->
            ...
            <div class="rounded-2xl border border-neutral-200 bg-white shadow-sm  ">
                <div class="p-6 sm:p-8">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <a href="{{ Storage::url($employee->curriculum_pdf_path) }}" target="_blank"
                                        ...
                                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none">
                                            <path d="M12 3v12m0 0l-3-3m3 3l3-3M6 21h12" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
                                        </svg>
                                        Ver currículo
                                    </a>
                                    @endif
                            ...
                            <div class="mt-3 flex flex-wrap items-center gap-2">
                                ...
                                <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-neutral-100 text-sm text-neutral-800">
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none">
                                        <path d="M2 5a3 3 0 013-3h2a3 3 0 013 3v2a3 3 0 01-3 3h0a12 12 0 0012 12h0a3 3 0 013-3h2a3 3 0 003 3v2a3 3 0 01-3 3h-2C8.82 24 0 15.18 0 5V3a3 3 0 013-3H5z" stroke="currentColor" stroke-width="1.5" />
                                    </svg>
                                    {{ $employee->phone }}
                                </span>
                                @endif
                                ...
                                <a href="{{ $employee->linkedin_url }}" target="_blank"
                                    ...
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M4.98 3.5A2.5 2.5 0 107.48 6a2.5 2.5 0 00-2.5-2.5zM4.5 8h3v12h-3zM9 8h2.78v1.64h.04a3.05 3.05 0 012.74-1.5c2.93 0 3.47 1.93 3.47 4.45V20h-3v-4.9c0-1.17-.02-2.67-1.63-2.67-1.64 0-1.89 1.28-1.89 2.59V20H9z" />
                                    </svg>
                                    LinkedIn
                                </a>
                                @endif
                                ...
                                <a href="{{ $employee->portfolio_url }}" target="_blank"
                                    ...
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none">
                                        <path d="M12 5l7 7-7 7-7-7 7-7z" stroke="currentColor" stroke-width="1.5" />
                                    </svg>
                                    Portfólio
                                </a>
                                @endif
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mt-2 text-neutral-700 leading-7 dark:text-neutral-300">{{ $employee->summary }}</p>
                    </div>
                    @endif
